            ...
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h5 class="mb-0 fw-bold">{{ $building->total_floors }}</h5>
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('real-estate.floors.create', ['building_id' => $building->id]) }}" 
                           class="btn btn-sm btn-primary">
                            <i class="bi bi-plus me-1"></i> Add Floor
                        </a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('real-estate.floors.create', ['building_id' => $building->id]) }}" 
                               class="btn btn-primary">
                                <i class="bi bi-plus-circle me-1"></i> Add First Floor
                            </a>
                        </div>
                    @endforelse
                </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('real-estate.floors.index', ['building_id' => $building->id]) }}" 
                           class="btn btn-outline-secondary">
                            <i class="bi bi-list me-1"></i> Manage Floors
                        </a>
                        <hr>
