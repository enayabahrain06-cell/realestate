...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('real-estate.tenants.show', $tenant) }}">{{ $tenant->full_name }}</a></li>
...
<div class="container-fluid">
    ...
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col">
                <h1 class="h3 mb-0 text-gray-800"><i class="bi bi-pencil-square text-warning me-2"></i>Edit Tenant</h1>
                <p class="text-muted small mb-0">Update tenant information</p>
            </div>
            <div class="col-auto">
                <a href="{{ route('real-estate.tenants.show', $tenant) }}" class="btn btn-outline-secondary">
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('real-estate.tenants.update', $tenant) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('full_name') is-invalid @endeo" 
                                           id="full_name" name="full_name" value="{{ old('full_name', $tenant->full_name) }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('id_number') is-invalid @endeo" 
                                       id="id_number" name="id_number" value="{{ old('id_number', $tenant->id_number) }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('employer') is-invalid @endeo" 
                                       id="employer" name="employer" value="{{ old('employer', $tenant->employer) }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('monthly_income') is-invalid @endeo" 
                                           id="monthly_income" name="monthly_income" value="{{ old('monthly_income', $tenant->monthly_income) }}" 
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @endeo" 
                                          ...
                                          placeholder="Additional notes about this tenant">{{ old('notes', $tenant->notes) }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mt-4 pt-3 border-top">
                            <button type="submit" class="btn btn-warning text-white me-2">
                                <i class="bi bi-check-circle me-1"></i> Update Tenant
                            </button>
                            <a href="{{ route('real-estate.tenants.show', $tenant) }}" class="btn btn-outline-secondary">
                                Cancel
                            </a>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header bg-white">
                    <h5 class="mb-0"><i class="bi bi-info-circle text-info me-2"></i>Statistics</h5>
                </div>
                <div class="card-body">
                    <div class="mb-2">
                        <strong>Active Leases:</strong>
                        {{ $tenant->leases()->where('status', 'active')->count() }}
                    </div>
                    <div class="mb-2">
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('real-estate.tenants.show', $tenant) }}" class="btn btn-outline-primary">
                            <i class="bi bi-eye me-1"></i> View Tenant
                        </a>
                        <a href="{{ route('real-estate.tenants.index') }}" class="btn btn-outline-secondary">
                            <i class="bi bi-list me-1"></i> All Tenants
                        </a>
                    </div>
                </div>
            </div>
